...
public enum Music {
    // Mister IA
    A_PROPOSTA("A Proposta", true, "23/05/2025 - 00:20", 3, 5, 3, new String[]{"v4.5", "forró piseiro", "mariaum", "letra original"}, new String[]{"A Proposta (Versão Mariaum)", "A Proposta (Versão Maraio)"}, new String[]{}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Guitar", "Keyboard", "Percussion", "Synth"}),
    ...
    ATRAPALHADOR("Atrapalhador", true, "04/07/2024 - 13:33", 0, 50, 2, new String[]{"v3.5", "rock", "jovem dinâmico", "rima", "letra original", "escatológica"}, new String[]{"Atrapalhador (Versão Piano)", "Atrapalhador (Versão Nórdica)"}, new String[]{"Atrapalhador (Versão Piano 1)", "Atrapalhador (Versão Piano 2)", "Atrapalhador (Versão Nórdica 1)"}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Guitar", "Synth"}),
    ...
    GALOPA_PRO_KINDOME("Galopa pro Kindome", true, "09/05/2025 - 21:09", 3, 3, 1, new String[]{"v4.5", "forró piseiro", "mariaum", "kindome", "letra ia"}, new String[]{"Galopa pro Kindome (Versão Mariaum)", "Galopa pro Kindome (Versão Maraio)"}, new String[]{}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Keyboard", "Synth", "FX", "Brass"}),
    ...
    AMOR_DESVELADO("Amor Desvelado", false, "31/05/2024 - 05:25", 0, 21, 0, new String[]{"udio", "pop", "explícita", "safira", "bruno", "letra ia"}, new String[]{}, new String[]{}, new String[]{}),
