...
public enum Music {
    ...
    ARROCHA_DO_JOVEM_DINAMICO("Arrocha do Jovem Dinâmico", false, "08/02/2025 - 19:23", 2, 66, 5, "Arrocha do Jovem Dinâmico (Versão Arrocha)"),
    ...
    CLAUDINHO("Claudinho", false, "11/01/2025 - 10:38", 2, 51, 3),
    ...
    DESTROY_EVERYTHING("Destroy Everything", false, "26/01/2025 - 22:11", 2, 59, 3),
    ...
    GOSTO_DE_COCO("Gosto de Cocô", false, "16/11/2024 - 14:05", 1, 69, 9),
    ...
    OLD_BURNING_LOVE("Old Burning Love", false, "18/02/2025 - 14:58", 2, 76, 6),
    OLHANDO_PARA_O_LADO("Olhando para o Lado", false, "10/07/2024 - 17:29", 0, 57, 1),
    ONI_CHAN("Oni-Chan", false, "03/01/2025 - 14:34", 2, 45, 1),
    ...
    TRES_PATINHOS("Três Patinhos", false, "08/01/2025 - 17:37", 2, 48, 5),
