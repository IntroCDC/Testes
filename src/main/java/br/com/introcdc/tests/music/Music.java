...
public enum Music {
    ...
    SANIDADE_MENTAL("Sanidade Mental", true, "27/09/2024 - 05:42", 1, 41, 15, new String[]{"v3.5", "metal", "explícita", "letra original", "desabafo", "eduarda", "safira", "rafael", "kindome"}, new String[]{"Sanidade Mental (Versão Piseiro)", "Sanidade Mental (Versão Seresta)", "Sanidade Mental (Versão Nórdica)"}, new String[]{"Sanidade Mental (Versão Nórdica 1)"}, new String[]{"Vocals", "Drums", "Bass", "Guitar", "Synth"}),
