...
public enum Music {
    ...
    ENTRADA_SEVERA("Entrada Severa", true, "09/05/2025 - 20:03", 3, 2, 1, new String[]{"v4.5", "metal", "severo", "discord", "letra original", "1 verso"}, new String[]{"Entrada Severa (Versão Pop)", "Entrada Severa (Versão Pagode)"}, new String[]{"Entrada Severa (Versão Pop 1)", "Entrada Severa (Versão Pagode 1)"}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Guitar"}),
    ...
    FOME_DINAMICA("Fome Dinâmica", false, "04/12/2025 - 13:21", 3, 33, 3, new String[]{"v5", "pagode", "jovem dinâmico", "escatológica", "letra original"}, new String[]{}, new String[]{}, new String[]{}),
