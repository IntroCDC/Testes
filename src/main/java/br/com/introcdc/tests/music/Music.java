...
public enum Music {
    ...
    LORENA("Lorena", true, "30/12/2024 - 18:01", 2, 29, 4, "Lorena (Versão Eletrônica)", "Lorena (Versão Funk)", "Lorena (Versão Opera)", "Lorena (Versão Piseiro)", "Lorena (Versão Rap)", "Lorena (Versão Reggae)", "Lorena (Versão Terror)"),
    ...
    TORNEIO_DE_YOUTUBERS("Torneio de YouTubers", true, "27/06/2025 - 17:48", 3, 17, 1, "Torneio de YouTubers (Versão Metal)", "Torneio de YouTubers (Versão Metal 1)", "Torneio de YouTubers (Versão Arrocha)", "Torneio de YouTubers (Versão Reggae)", "Torneio de YouTubers (Versão Arrocha 1)", "Torneio de YouTubers (Versão Reggae 1)"),
