...
public enum Music {
    ...
    ARROCHA_DO_MARIAUM("Arrocha do Mariaum", true, "03/06/2025 - 05:14", 3, 6, 1, new String[]{"v4.5", "arrocha", "mariaum", "bruno", "severo", "letra original"}, new String[]{"Arrocha do Mariaum (Versão Mariaum)", "Arrocha do Mariaum (Versão Brega)", "Arrocha do Mariaum (Versão Metal)", "Arrocha do Mariaum (Versão Nórdica)"}, new String[]{"Arrocha do Mariaum (Versão Brega 1)", "Arrocha do Mariaum (Versão Metal 1)", "Arrocha do Mariaum (Versão Metal 2)", "Arrocha do Mariaum (Versão Metal 3)", "Arrocha do Mariaum (Versão Metal 4)", "Arrocha do Mariaum (Versão Metal 5)", "Arrocha do Mariaum (Versão Nórdica 1)"}, new String[]{"Vocals", "Drums", "Bass", "Percussion", "Synth", "Woodlands"}),
    ...
    INTROBASE64("IntroBase64", true, "09/06/2024 - 06:39", 0, 29, 2, new String[]{"v3.5", "épica", "introbase64", "letra original", "vídeo do canal", "meel"}, new String[]{"IntroBase64 (Versão Metal)", "IntroBase64 (Versão Arrocha)", "IntroBase64 (Versão Nórdica)"}, new String[]{"IntroBase64 (Versão Metal 1)", "IntroBase64 (Versão Metal 2)", "IntroBase64 (Versão Metal 3)", "IntroBase64 (Versão Metal 4)", "IntroBase64 (Versão Arrocha 1)", "IntroBase64 (Versão Nórdica 1)"}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Guitar", "Synth", "FX"}),
    ...
    MARIAUM_E_JAPONESA("Mariaum e Japonesa", true, "03/01/2025 - 14:51", 2, 46, 1, new String[]{"v4", "sertanejo", "mariaum", "letra ia"}, new String[]{"Mariaum e Japonesa (Versão Mariaum)", "Mariaum e Japonesa (Versão Funk)", "Mariaum e Japonesa (Versão K-Pop)", "Mariaum e Japonesa (Versão Metal)", "Mariaum e Japonesa (Versão Piano)", "Mariaum e Japonesa (Versão Reggae)", "Mariaum e Japonesa (Versão Salsa)", "Mariaum e Japonesa (Versão Brega)", "Mariaum e Japonesa (Versão Pagode)", "Mariaum e Japonesa (Versão Nórdica)"}, new String[]{"Mariaum e Japonesa (Versão K-Pop 1)", "Mariaum e Japonesa (Versão Metal 1)", "Mariaum e Japonesa (Versão Metal 2)", "Mariaum e Japonesa (Versão Piano 1)", "Mariaum e Japonesa (Versão Salsa 1)", "Mariaum e Japonesa (Versão Brega 1)", "Mariaum e Japonesa (Versão Pagode 1)", "Mariaum e Japonesa (Versão Nórdica 1)"}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Synth", "FX"}),
    ...
    OPRESSOR_DEPRECIADOR("Opressor Depreciador", true, "06/08/2025 - 03:53", 3, 20, 6, new String[]{"v4.5+", "metal", "jovem dinâmico", "letra original", "explícita"}, new String[]{"Opressor Depreciador (Versão Brega)", "Opressor Depreciador (Versão Nórdica)"}, new String[]{"Opressor Depreciador (Versão Nórdica 1)"}, new String[]{"Vocals", "Drums", "Bass", "Guitar", "Synth", "FX"}),
