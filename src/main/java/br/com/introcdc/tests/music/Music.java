...
public enum Music {
    ...
    ARROCHA_DO_JOVEM_DINAMICO("Arrocha do Jovem Dinâmico", true, "08/02/2025 - 19:23", 2, 66, 5, new String[]{"v4", "metal", "jovem dinâmico", "explícita", "letra original", "escatológica"}, new String[]{"Arrocha do Jovem Dinâmico (Versão Arrocha)", "Arrocha do Jovem Dinâmico (Versão Piseiro)", "Arrocha do Jovem Dinâmico (Versão Censurada)", "Arrocha do Jovem Dinâmico (Versão Brega)"}, new String[]{"Arrocha do Jovem Dinâmico (Versão Brega 1)", "Arrocha do Jovem Dinâmico (Versão Brega 2)", "Arrocha do Jovem Dinâmico (Versão Brega 3)"}, new String[]{"Vocals", "Drums", "Bass", "Guitar", "Synth"}),
    ARROCHA_DO_MARIAUM("Arrocha do Mariaum", true, "03/06/2025 - 05:14", 3, 6, 1, new String[]{"v4.5", "arrocha", "mariaum", "bruno", "severo", "letra original"}, new String[]{"Arrocha do Mariaum (Versão Mariaum)", "Arrocha do Mariaum (Versão Brega)", "Arrocha do Mariaum (Versão Metal)"}, new String[]{"Arrocha do Mariaum (Versão Brega 1)", "Arrocha do Mariaum (Versão Metal 1)", "Arrocha do Mariaum (Versão Metal 2)", "Arrocha do Mariaum (Versão Metal 3)", "Arrocha do Mariaum (Versão Metal 4)", "Arrocha do Mariaum (Versão Metal 5)"}, new String[]{"Vocals", "Drums", "Bass", "Percussion", "Synth", "Woodlands"}),
    ...
    INTROBASE64("IntroBase64", true, "09/06/2024 - 06:39", 0, 29, 2, new String[]{"v3.5", "épica", "introbase64", "letra original", "vídeo do canal", "meel"}, new String[]{"IntroBase64 (Versão Metal)", "IntroBase64 (Versão Arrocha)"}, new String[]{"IntroBase64 (Versão Metal 1)", "IntroBase64 (Versão Metal 2)", "IntroBase64 (Versão Metal 3)", "IntroBase64 (Versão Metal 4)", "IntroBase64 (Versão Arrocha 1)"}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Guitar", "Synth", "FX"}),
    ...
    OLD_BURNING_LOVE("Old Burning Love", true, "18/02/2025 - 14:58", 2, 76, 6, new String[]{"v4", "metal", "instrumental", "safira"}, new String[]{"Old Burning Love (Versão Arrocha)", "Old Burning Love (Versão Piano)"}, new String[]{"Old Burning Love (Versão Arrocha 1)", "Old Burning Love (Versão Piano 1)"}, new String[]{"Drums", "Bass", "Guitar", "Keyboard", "Synth", "FX"}),
    ...
    SARAIVA("Saraiva", true, "09/02/2025 - 15:05", 2, 68, 11, new String[]{"v4", "forró piseiro", "saraiva", "luciano", "letra original"}, new String[]{"Saraiva (Versão Reggae)", "Saraiva (Versão Rock)", "Saraiva (Versão Metal)", "Saraiva (Versão Piano)", "Saraiva (Versão Arrocha)", "Saraiva (Versão Salsa)", "Saraiva (Versão Jazz)"}, new String[]{"Saraiva (Versão Rock 1)", "Saraiva (Versão Reggae 1)", "Saraiva (Versão Metal 1)", "Saraiva (Versão Arrocha 1)", "Saraiva (Versão Salsa 1)", "Saraiva (Versão Jazz 1)"}, new String[]{"Vocals", "Backing Vocals", "Drums", "Bass", "Keyboard", "Synth", "FX"}),
    ...
    TORNEIO_DE_YOUTUBERS("Torneio de YouTubers", true, "27/06/2025 - 17:48", 3, 17, 1, new String[]{"v4.5", "épica", "instrumental", "kindome"}, new String[]{"Torneio de YouTubers (Versão Metal)", "Torneio de YouTubers (Versão Arrocha)", "Torneio de YouTubers (Versão Reggae)", "Torneio de YouTubers (Versão Salsa)"}, new String[]{"Torneio de YouTubers (Versão Metal 1)", "Torneio de YouTubers (Versão Arrocha 1)", "Torneio de YouTubers (Versão Reggae 1)", "Torneio de YouTubers (Versão Salsa 1)"}, new String[]{"Drums", "Bass", "Keyboard", "Percussion", "Strings", "Synth", "FX"}),
    ...
    TUBARAO("Tubarão", true, "18/12/2024 - 16:08", 2, 11, 3, new String[]{"v4", "arrocha", "explícita", "letra original"}, new String[]{"Tubarão (Versão Metal)", "Tubarão (Versão Funk)", "Tubarão (Versão Calma)"}, new String[]{"Tubarão (Versão Metal 1)", "Tubarão (Versão Metal 2)", "Tubarão (Versão Metal 3)", "Tubarão (Versão Funk 1)", "Tubarão (Versão Calma 1)"}, new String[]{"Vocals", "Drums", "Bass", "Percussion", "FX"}),
    ...
    DIVERSAO_NO_MUSH("Diversão no Mush", false, "24/04/2024 - 12:46", 0, 2, 0, new String[]{"udio", "pagode", "mariaum", "letra ia"}, new String[]{}, new String[]{}, new String[]{}),
    ...
    GABRIEL_PARA_JABRIEL("Gabriel para Jabriel", false, "31/12/2024 - 20:10", 2, 34, 1, new String[]{"v4", "sertanejo", "gabriel", "letra original"}, new String[]{}, new String[]{}, new String[]{}),
    ...
    NIGHT("Night", false, "03/10/2025 - 03:52", 3, 26, 2, new String[]{"v5", "instrumental", "piano"}, new String[]{"Night (Versão Arrocha)", "Night (Versão Violino)", "Night (Versão Metal)"}, new String[]{"Night (Versão Arrocha 1)", "Night (Versão Violino 1)", "Night (Versão Metal 1)"}, new String[]{}),
    ...
    THE_END("The End", false, "05/02/2025 - 01:29", 2, 64, 4, new String[]{"v4", "piano", "eduarda", "instrumental"}, new String[]{"The End (Versão Metal)", "The End (Versão Arrocha)"}, new String[]{"The End (Versão Arrocha 1)"}, new String[]{}),
