...
public enum Music {
    ...
    THE_IMPOSSIBLE("The Impossible", true, "15/02/2025 - 04:35", 2, 74, 5, "The Impossible (Versão Orquestra)", "The Impossible (Versão Reggae)", "The Impossible (Versão Épica 1)", "The Impossible (Versão Épica 2)", "The Impossible (Versão Orquestra 1)"),
    ...
    CHEGOU_O_REMEDIO("Chegou o Remédio", false, "02/01/2025 - 11:12", 2, 41, 1, "Chegou o Remédio (Versão Reggae)", "Chegou o Remédio (Versão Reggae 1)"),
    ...
    SARAIVA("Saraiva", false, "09/02/2025 - 15:05", 2, 68, 11),
