...
public enum Music {
    ...
    ARROCHA_DO_MARIAUM("Arrocha do Mariaum", true, "03/06/2025 - 05:14", 3, 6, 1, new String[]{"v4.5", "arrocha", "mariaum", "bruno", "severo", "letra original"}, new String[]{"Arrocha do Mariaum (Versão Mariaum)", "Arrocha do Mariaum (Versão Brega)", "Arrocha do Mariaum (Versão Metal)", "Arrocha do Mariaum (Versão Nórdica)", "Arrocha do Mariaum (Versão Maraio)", "Arrocha do Mariaum (Versão 8 Bit)"}, new String[]{"Arrocha do Mariaum (Versão Brega 1)", "Arrocha do Mariaum (Versão Metal 1)", "Arrocha do Mariaum (Versão Metal 2)", "Arrocha do Mariaum (Versão Metal 3)", "Arrocha do Mariaum (Versão Metal 4)", "Arrocha do Mariaum (Versão Metal 5)", "Arrocha do Mariaum (Versão Nórdica 1)", "Arrocha do Mariaum (Versão 8 Bit 1)"}, new String[]{"Vocals", "Drums", "Bass", "Percussion", "Synth", "Woodlands"}),
    ...
    NAO_MEXE("NÃO MEXE", false, "29/01/2026 - 06:57", 3, 36, 6, new String[]{"v5", "8 bit", "jovem dinâmico", "gatinhas", "letra original"}, new String[]{}, new String[]{}, new String[]{}),
    ...
    TROPA_DO_SNIFFER("Tropa do Sniffer", false, "15/03/2026 - 22:55", 3, 38, 0, new String[]{"v3.5", "pop", "prist", "jaozn"}, new String[]{"Tropa do Sniffer (Versão Nórdica)", "Tropa do Sniffer (Versão Metal)", "Tropa do Sniffer (Versão Reggae)"}, new String[]{"Tropa do Sniffer (Versão Nórdica 1)", "Tropa do Sniffer (Versão Metal 1)", "Tropa do Sniffer (Versão Reggae 1)"}, new String[]{}),
