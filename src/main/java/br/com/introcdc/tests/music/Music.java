...
public enum Music {
    ...
    A_PROPOSTA("A Proposta", false, "23/05/2025 - 00:20", 3, 5, 3, new String[]{"v4.5", "forró piseiro", "mariaum", "letra original"}, new String[]{"A Proposta (Versão Mariaum)", "A Proposta (Versão Maraio)"}, new String[]{}, new String[]{}),
