...
public class ForumMethods {
    ...
    public static final Map<String, String> TAG_DESCRIPTION = ImmutableMap.<String, String>builder()
            ...
            .put("maria lucia segundo", "Sobrinha, filha de Luciano").put("seis", "Ex-Amigo, conhecido pelo Corvum em 2021")
            ...
            .put("keroch", "Ex-amigo, conhecido pelo Biidu, Meel, MinecraftGames em 2015").put("safira rodrigues", "Ex-Amiga, conhecida pelo Kindome em 2021")
