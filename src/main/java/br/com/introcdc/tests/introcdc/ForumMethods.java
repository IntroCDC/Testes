...
/*
 * Written by IntroCDC, Bruno Coêlho at 21/12/2022 - 07:02
 */
...
public class ForumMethods {
    ...
    public static final Map<String, String> TAG_DESCRIPTION = ImmutableMap.<String, String>builder()
            ...
            .put("gabriel christian", "Ex-Amigo, conhecido no Norte Shopping em 2020").put("lelahel", "Amigo, conhecido pelo Kindome em 2021")
